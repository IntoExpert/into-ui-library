...
import { SchedulerTable } from "../../components/schduler/weeklyView/table/table";
import { Slot } from "../../components/schduler/celll/slot";
import { MonthlyView } from "../../components/schduler/monthlyView/monthlyView";
...
} as ComponentMeta<typeof MonthlyView>;

const Template: ComponentStory<typeof MonthlyView> = (args) => (
  <MonthlyView {...args} />
);
const imageUR =
...
BasicScheduler.args = {
  events: [
    ...
    },
    {
      ...
      startTime: "2024-07-31T11:00",
      endTime: "2024-07-31T11:30",
      merge: false,
    },
  ],
};
